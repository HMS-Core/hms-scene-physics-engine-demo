...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Starts the PhysicsEngineDemoOneActivity,
     * a callback method which is called upon a tap on the "PHYSICS ENGINE 1" button.
     * @param view View that is tapped.
     */
    public void onBtnPhysicsEngineDemoOneClicked(View view) {
        if (!initialized) {
            initializeSceneKit();
            return;
        }
        startActivity(new Intent(this, PhysicsEngineSampleOneActivity.class));
    }

    /**
     * Starts the PhysicsEngineDemoTwoActivity,
     * a callback method which is called upon a tap on the "PHYSICS ENGINE 2" button.
     * @param view View that is tapped.
     */
    public void onBtnPhysicsEngineDemoTwoClicked(View view) {
        if (!initialized) {
            initializeSceneKit();
            return;
        }
        startActivity(new Intent(this, PhysicsEngineSampleTwoActivity.class));
    }
